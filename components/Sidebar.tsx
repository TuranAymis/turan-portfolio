...
const Sidebar: React.FC<SidebarProps> = ({ currentView, changeView, t }) => {
  ...
  return (
    <div className="w-64 bg-[#0f172a] border-r border-ide-border h-screen flex flex-col shrink-0">
      
      {/* Sidebar Header */}
      <div className="h-12 flex items-center px-4 border-b border-ide-border gap-2">
        <Layout size={18} className="text-blue-500" />
        <span className="font-bold text-sm tracking-tight">QA_WORKSPACE</span>
      </div>
